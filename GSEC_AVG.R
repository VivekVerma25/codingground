...
path_output<-"D:/LFT/Template/tester/R test data/full simulation/FINAL FILES/OUTPUT/GSEC AVG/"
...
names(fac_list) <- list("GSEC AVG")

fac_list[[1]] = data.frame(fac_1[,1],(list_IN_P[[1]][,-1] + list_IN_P[[2]][,-1]+ list_IN_P[[3]][,-1] +list_IN_P[[4]][,-1])/4)
