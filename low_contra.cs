...
{
    public class low_contra : BasicStrategy
    {
        ...
        public low_contra(string stratName, double alloc, double cost, double timeStep)
                        ...
                        if (data.InputData[i].Dates[timestep].TimeOfDay >= DataRefStartTime && data.InputData[i].Dates[timestep].TimeOfDay <= DataRefEndTime)
                        {
                            ...
                            if (series2.Length > lbk2)
                            {
                                ...
                                if (data.InputData[i].Dates[timestep].TimeOfDay >= TrdEntryStartTime && data.InputData[i].Dates[timestep].TimeOfDay < TrdEntryEndTime)
                                {
                                    ...
                                    double z1 = (Math.Log(close.Last()/ltp_stock[timestep]) - avg1) / std1;
                                    double z2 = (Math.Log(close.Last()/ltp_stock[timestep]) - avg3) / std3;
                                    ...
                                    if (z1 >= siglevel1 && /*ltp_stock[timestep] > close.Last() && (Math.Log(ltp_stock[timestep] / lw) > 0.0) && z2 <= siglevel2 &&*/ np[timestep - 1] != 1 && (mode == "A" || mode == "S") && shorttrades < SC && flagS <= 0 && ltp_stock[timestep] > 20.0)
                                    {
                                    ...
                                    if (z2 <= -siglevel1 && /*ltp_stock[timestep] < close.Last() && (Math.Log(ltp_stock[timestep] / hi) < 0.0) && z1 <= siglevel1 &&*/ np[timestep - 1] != -1 && (mode == "A" || mode == "L") && longtrades < LC  && flagL <= 0 && ltp_stock[timestep] > 20.0)
                                    {
