...
{
    public class test10 : BasicStrategy
    {
        ...
        public test10(string stratName, double alloc, double cost, double timeStep)
                        ...
                        if (data.InputData[i].Dates[timestep].TimeOfDay >= DataRefStartTime && data.InputData[i].Dates[timestep].TimeOfDay <= DataRefEndTime)
                        {
                            ...
                            if (series2.Length > lbk2)
                            {
                                ...
                                if (data.InputData[i].Dates[timestep].TimeOfDay >= TrdEntryStartTime && data.InputData[i].Dates[timestep].TimeOfDay < TrdEntryEndTime)
                                {
                                    ...
                                    if (z1 >= siglevel1 && (Math.Log(ltp_stock[timestep] / lw)) >0.0 && np[timestep - 1] != -1 && (mode == "A" || mode == "S") && shorttrades < SC && flagS <= 0 && ltp_stock[timestep] > 20.0 && tt < lbk3)
                                    {
                                    ...
                                    if (z2 >= siglevel2 && (Math.Log(ltp_stock[timestep] / hi)) < 0.0 && np[timestep - 1] != 1 && (mode == "A" || mode == "L") && longtrades < LC && flagL <= 0 && ltp_stock[timestep] > 20.0 && tt < lbk3)
                                    {
