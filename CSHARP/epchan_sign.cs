                        ...
                        if (data.InputData[i].Dates[timestep].TimeOfDay >= DataRefStartTime && data.InputData[i].Dates[timestep].TimeOfDay <= DataRefEndTime)
                        {
                            ...
                            if (series2.Length > lbk2)
                            {
                                ...
                                if (data.InputData[i].Dates[timestep].TimeOfDay >= TrdEntryStartTime && data.InputData[i].Dates[timestep].TimeOfDay < TrdEntryEndTime)
                                {
                                    ...
                                    if (z1 >= siglevel2 && /*ltp_stock[timestep] > close.Last() && (Math.Log(ltp_stock[timestep] / lw) > 0.0) && z2 <= siglevel2 &&*/ np[timestep - 1] != -1 && (mode == "A" || mode == "L") && shorttrades < SC && flagS <= 0 && ltp_stock[timestep] > 0.0 && tt < lbk3)
                                    {
                                    ...
                                    if (z2 <= -siglevel1 && /*ltp_stock[timestep] < close.Last() && (Math.Log(ltp_stock[timestep] / hi) < 0.0) && z1 <= siglevel1 &&*/ np[timestep - 1] != 1 && (mode == "A" || mode == "S") && longtrades < LC && flagL <= 0 && ltp_stock[timestep] > 0.0 && tt < lbk3)
                                    {
