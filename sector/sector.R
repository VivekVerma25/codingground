...
RAW_CLOSE= data.frame(read.csv(paste(path_input,"CASH DB/","px_last.csv",sep="")))
...
######################################################################################################################################################
RAW_CLOSE= data.frame(read.csv(paste(path_input,"CASH DB/","px_last.csv",sep="")))
RAW_HIGH= data.frame(read.csv(paste(path_input,"CASH DB/","px_high.csv",sep="")))
RAW_LOW= data.frame(read.csv(paste(path_input,"CASH DB/","px_low.csv",sep="")))
RAW_OPEN= data.frame(read.csv(paste(path_input,"CASH DB/","px_open.csv",sep="")))
...
for(l in 1:length(lookback_period)){
  ...
  list_factor1[[l]] = NEGATIVE( PER_CHANGE(RAW_CLOSE,lookback_period[[l]]))
