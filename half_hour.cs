...
{
    public class half_hour : BasicStrategy
    {
        ...
        public half_hour(string stratName, double alloc, double cost, double timeStep)
        ...
        public override void RunStrategy(StrategyData data)
        {
            ...
            for (int i = 0; i < numSec; i++)
            {
                ...
                for (int timestep = 1; timestep < (len); timestep++)
                {
                    ...
                    if (((timeintrade >= (zzz + 1) && timeintrade >= et1) || timeintrade >= et2) && np[timestep - 1] != 0)
                    {
