...
path_output<-"D:/LFT/Template/tester/R test data/full simulation/FINAL FILES/OUTPUT/PESTP N50/"
...
list_PEST <- vector('list',9)


#list_PEST <- vector('list',2)
#lookback_period=c(10,20)
lookback_period=c(10,20,40,60,90,120,150,180,240)
# 
...
names(list_PEST) <- list("PEST10","PEST20","PEST40","PEST60","PEST90","PEST120","PEST150","PEST180","PEST240")
