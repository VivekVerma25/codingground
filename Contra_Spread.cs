...
{
    public class Contra_Spread : BasicStrategy
    {
        ...
        public Contra_Spread(string stratName, double alloc, double cost, double timeStep)
                           ...
                           /* if (Move2.Count() > lbk3)
                            ...
                            if (series1.Length > lbk2)
                            {
                                ...
                                if (data.InputData[i].Dates[timestep].TimeOfDay >= TrdEntryStartTime && data.InputData[i].Dates[timestep].TimeOfDay < TrdEntryEndTime)
                                {
                                    ...
                                    if (z1 >= siglevel1 && z1 <= siglevel3 && np[timestep - 1] != 1 && (mode == "A" || mode == "L") && flag <= 0 && currentmove1 < 0.0 && ltp_stock[timestep] >= 20.0)
                                    {
