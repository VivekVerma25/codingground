...
path_output<-"D:/LFT/Template/tester/R test data/full simulation/FINAL FILES/OUTPUT/PESTP N50 DN1/"
...
stapp = data.frame(read.csv(paste(path_input,"UNIVERSE/","Nifty50.csv",sep="")))
