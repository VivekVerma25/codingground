...
path_output<-"D:/LFT/Template/tester/R test data/full simulation/FINAL FILES/OUTPUT/BASIS OP/"
...
stapp = data.frame(read.csv(paste(path_input,"UNIVERSE/","AFO-N50.csv",sep="")))
