...
path_output<-"D:/LFT/Template/tester/R test data/full simulation/FINAL FILES/OUTPUT/GSEC1/"
...
######################################################################################################################################################
RAW_IN_PRICE= data.frame(read.csv(paste(path_input,"CASH DB/","global sec px_last delay1.csv",sep="")))
