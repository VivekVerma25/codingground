...
{
    public class test6 : BasicStrategy
    {
        ...
        public test6(string stratName, double alloc, double cost, double timeStep)
        ...
        public override void RunStrategy(StrategyData data)
        {
            ...
            for (int i = 0; i < numSec; i++)
            {
                ...
                for (int timestep = 1; timestep < (len); timestep++)
                {
                    ...
                    if ((timeintrade >= Math.Max(5 * (z1_max_i + 1), et1) || timeintrade >= et2) && np[timestep - 1] != 0)
                    {
