...
{
    public class contra_spread_corr : BasicStrategy
    {
        ...
        public contra_spread_corr(string stratName, double alloc, double cost, double timeStep)
                        ...
                        if (data.InputData[i].Dates[timestep].TimeOfDay >= DataRefStartTime && data.InputData[i].Dates[timestep].TimeOfDay <= DataRefEndTime)
                        {
                            ...
                            if (series1.Length > lbk2)
                            {
                                ...
                                if (data.InputData[i].Dates[timestep].TimeOfDay >= TrdEntryStartTime && data.InputData[i].Dates[timestep].TimeOfDay < TrdEntryEndTime)
                                {
                                    ...
                                    if (z1 >= siglevel1 && np[timestep - 1] != 1 && (mode == "A" || mode == "L") && flag <= 0 && currentmove1 < 0.0 && ltp_stock[timestep] >= 20.0)
                                    {
                                        ...
                                        if (z2 >= siglevel2)
                                        {
                                            if (Move3.Count() > lbk4 && Move4.Count() > lbk4)
                                            {
