...
fac_list = data.frame(read.csv(paste(path_input,"SELECTED OPTIONS RATIOS.csv",sep="")))
...
uni_list = data.frame(read.csv(paste(path_input,"UNIVERSE_OP_FUT OI RATIO.csv",sep="")))
