...
path_output<-"D:/LFT/Template/tester/R test data/full simulation/OPTIONS Z SCORE AVG2/"
...
fac_list = data.frame(read.csv(paste(path_input,"OP 250Z SCORE OF AVG.csv",sep="")))
