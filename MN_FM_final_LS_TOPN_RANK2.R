...
path_output<-"D:/LFT/Template/tester/R test data/full simulation/OP FINAL TEST1/"
...
fac_list = data.frame(read.csv(paste(path_input,"OP FINAL.csv",sep="")))
...
uni_list = data.frame(read.csv(paste(path_input,"OP UNI.csv",sep="")))
