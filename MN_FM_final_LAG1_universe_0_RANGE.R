...
path_output<-"D:/LFT/Template/tester/R test data/full simulation/FINAL ANALYST UNI/"
...
fac_list = data.frame(read.csv(paste(path_input,"analyst factors sign.csv",sep="")))
...
uni_list = data.frame(read.csv(paste(path_input,"UNIVERSE_ANALYST - Copy.csv",sep="")))
