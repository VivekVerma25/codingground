...
{
    public class epchan_reversal : BasicStrategy
    {
        ...
        public epchan_reversal(string stratName, double alloc, double cost, double timeStep)
                    ...
                    if (series1.Length > lbk && data.InputData[i].Dates[timestep].Date == data.InputData[i].Dates[timestep - 1].Date)
                    {
                        ...
                        if (data.InputData[i].Dates[timestep].TimeOfDay >= DataRefStartTime && data.InputData[i].Dates[timestep].TimeOfDay <= DataRefEndTime)
                        {
                            ...
                            if (series2.Length > lbk2)
                            {
                                ...
                                {
                                    double z1 = ((Math.Log(open.Last() / lw)) - avg1) / std1;
                                    double z2 = ((Math.Log(open.Last() / hi)) - avg1) / std1;


                                    Zscore1[timestep] = z1;
                                    Zscore2[timestep] = z2;

                                    if (z1 <= siglevel1 && np[timestep - 1] != -1 && (mode == "A" || mode == "S") && shorttrades < SC && flagS <= 0 && ltp_stock[timestep] > 20.0)
                                    {
                                    ...
                                    if (z1 >= -siglevel2 && np[timestep - 1] != 1 && (mode == "A" || mode == "L") && longtrades < LC && flagL <= 0 && ltp_stock[timestep] > 20.0)
                                    {
